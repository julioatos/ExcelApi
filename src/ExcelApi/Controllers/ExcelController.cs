...
namespace ExcelApi.Controllers
{
    ...
    public class ExcelController : ControllerBase
    {
            ...
            if (fileExtension == ".xlsx" || fileExtension == ".XLSX")
            {
                using (var stream = new MemoryStream())
                {
                    ...
                    using (var reader = ExcelReaderFactory.CreateReader(stream))
                    {
                        ...
                        {
                            var test = result.Tables[0].Rows[5][0];
                            Ok(result.Tables[0].Rows.Count);
                        }
                    }
                }
            }
        ...
        //[HttpPost]
        //public ActionResult cargarArchivo(string postUrl, string userAgent, string contentType, byte[] formData, string headerkey, string headervalue) {
